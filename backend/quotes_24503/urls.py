"""quotes_24503 URL Configuration
...
admin.site.site_header = "quotes"
admin.site.site_title = "quotes Admin Portal"
admin.site.index_title = "quotes Admin"

# swagger
api_info = openapi.Info(
    title="quotes API",
    default_version="v1",
    description="API documentation for quotes App",
)
